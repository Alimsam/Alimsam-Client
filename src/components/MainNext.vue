  ...
  <div class="hello">
    ...
    <div class = "wrapper">
      <nav class="sidebar">
        ...
        <div class="group"><button class = "sidemenu" v-on:click="gotoMeal('Meal')"><span><img src="../assets/meal2.png" width="40%" class="icon"></span><span><img src="../assets/school.png" width="40%" class="icon"></span><h4>급식/학사일정 확인</h4></button>
          ...
          <button class = "sidemenu" v-on:click="gotoMoving('Moving')"><span><img src="../assets/run2.png" width="40%" class="icon"></span><h4>자습이동</h4></button>          </div>
        <div class = "copydiv"><p class = "copyright">Copyright.2019.MSD.All rights reserved.</p></div>
      </nav>
    </div>
    <div class="pngdiv">
      <img src="../assets/mainNext.png" width="40%" class="pngstyle">
    </div>
    <div class="hellodiv">
      <p class="hellotext"><span class="helloim">학생</span>들의 <span class="helloim">학생</span>들에 의한 <span class="helloim">학생</span>들을 위한</p>
      <p class="hellomain">알림쌤</p>
    </div>
  </div>
</div>
</template>
