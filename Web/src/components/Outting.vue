<template>
  ...
  <div class="hello">
    ...
    <div class="hellodiv">
      <b-button v-b-modal.modal-prevent-closing variant="outline-primary" class = "plznotice">엄지 딱 대</b-button>
        <b-modal
        id="modal-prevent-closing"
        ref="modal"
        title="이름과 지문을 등록해주세요."
        @show="resetModal"
        @hidden="resetModal"
        @ok="handleOk"
        >
            <ValidationObserver v-slot="{invalid}">
                <form @submit.prevent="onSubmit">
                    <ValidationProvider rules="required" v-slot="{ errors }" name="field">
                        <div class = "form_div">이름</div>
